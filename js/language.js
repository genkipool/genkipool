var arrLang = {
      'en': {
        ...
        'serviceD': 'SERVICE',
        'target': 'My goal with the pool is to achieve financial freedom and that of delegates if possible, also to get people to free themselves from banks, own their own money and have many more opportunities to obtain loans, aid and the possibility of moving your money anywhere in the world, all of that will give humanity much more freedom. By creating the pool, I think I am doing my bit to achieve that goal.',
      ...
      'es': {
        ...
        'serviceD': 'SERVICIO',
        'target': 'Mi objetivo con el pool es conseguir la libertad financiera y la de los delegantes si es posible, también conseguir que las personas se liberen de los bancos, sean dueños de su propio dinero y tengan muchas más oportunidades de obtener prestamos, ayudas y la posibilidad de mover su dinero a cualquier parte del mundo, todo eso le dará mucha más libertad a la humanidad. Creando el pool creo que pongo mi granito de arena a conseguir ese objetivo.',
